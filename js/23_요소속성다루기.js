...
closeBtn.addEventListener("click", () => {
  ...
  // .btn-container 가 hidden 클래스를 포함하지 않을 경우
  if(!btnContainer.classList.contains("hidden")){
    btnContainer.classList.add("hidden"); // 히든 추가
    addBtn.classList.remove("hidden"); // 히든 제거
  }
